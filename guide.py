...
print("hello", end=" ") #بتنزل سطر تلقائيا فهنا حددنا ان النهاية تكون مسافة بدل سطر جديد printال
...
print(txt.split()[2]) # indx 2 هنا بطبع indx 3 فبالتالى بيطبع ليست ب txt قسمت ال
